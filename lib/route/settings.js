...
router.post('/bankholidays/import/:company_id?', (req, res) => {
...
router.post('/bankholidays/delete/:bank_holiday_number/:company_id?', function(req, res){
