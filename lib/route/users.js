...
router.get('/', function(req, res) {
    ...
    users_filter = {},
    company_filter = {},
    department_id = req.param('department');
...
function get_and_validate_user_parameters(args) {
    ...
    var name     = validator.trim(req.param('name')),
        ...
        nickname = validator.trim(req.param('nickname')),
        ...
        isManager         = validator.toBoolean(req.param('supervisor')),
        auto_approve      = validator.toBoolean(req.param('auto_approve')),
        carried_over_allowance = validator.trim(req.param('carried_over_allowance')),
        user_leave      = validator.trim(req.param('user_leave')),
        calculated_sickleaves      = validator.trim(req.param('user_sick_leave'));
