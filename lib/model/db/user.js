...
function get_instance_methods(sequelize) {
  ...
  return {
    ...
    promise_supervised_departments : function() {
      ...
      if (self.isManager != true){ //if user is not manager/department head user, ignore every department head setting
    ...
    // promise_to_return_AL_entitlement : function(){
    //   let self = this,
    //       total_years_of_service = (moment().diff(self.start_date, 'days',false))/365,
    //       full_year_of_service = Math.floor(total_years_of_service),
    //       partial_year_of_service = total_years_of_service%1,
    //       total_AL_entitlment;

    //   var end = moment("2018-02-01", "YYYY-MM-DD");
    //   var start = moment("2019-02-01", "YYYY-MM-DD");
    //   let Totaldays = moment.duration(start.diff(end)).asDays();

    //   if (total_years_of_service <= 2){
    //     total_AL_entitlment = 15;
    //   }else
    //   if (total_years_of_service > 2 && total_years_of_service <= 4){
    //     total_AL_entitlment = 17;
    //   }else
    //   if (total_years_of_service > 4 && total_years_of_service <= 7){
    //     total_AL_entitlment = 19;
    //   }else
    //   if (total_years_of_service > 7 && total_years_of_service <= 10){
    //     total_AL_entitlment = 21;
    //   }else
    //   if (total_years_of_service > 10 && total_years_of_service <= 15){
    //     total_AL_entitlment = 23;
    //   }else{
    //     total_AL_entitlment = 25;
    //   }
    //   console.log("total Days =>"+ Totaldays + ",To years=>" + Totaldays/365);
    //   console.log("total =>" +total_years_of_service +", full =>" + full_year_of_service + ", partial =>" + partial_year_of_service);
    // },
  };
