...
function add_user(args) {
  ...
  attributes.staffId      = args.staffId;
  ...
  attributes.superadmin    = args.superadmin;
...
function add_users_in_bulk(args) {
  ...
  let company,
    staffId_vector_index    = 0,
    email_vector_index      = 1,
    lastname_vector_index   = 2,
    name_vector_index       = 3,
    nickname_vector_index   = 4,
    category_vector_index   = 5,
    department_vector_index = 6,
    start_date_vector_index = 7,
    leave_vector_index      = 8,
    cf_vector_index         = 9,
    mc_vector_index         = 10;
  ...
  .then(() => {
    return Promise.map(bulk_data, vector => {
      ...
      return Promise.resolve()
        .then(() => add_user({
          staffId       : vector [staffId_vector_index],
          email         : email,
          ...
          category      : vector[ category_vector_index ],
