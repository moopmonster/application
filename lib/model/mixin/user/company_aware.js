...
module.exports = function(sequelize){
  ...
  this.get_company_for_user_details = function(args){
    ...
    // return current_user.getCompany({
      include : [
        {
  ...
  // Create a basic Company - User - Department version of the above
  this.get_company_for_user_details_basic = function(args){
    var user_id    = args.user_id,
      year         = args.year || moment.utc(),
      current_user = this;
  ...
  this.get_company_for_add_user = function(companyID) {
  ...
  //   return this.getCompany({
  //     include : [{ model : sequelize.models.LeaveType, as : 'leave_types' },
  //                { model : sequelize.models.BankHoliday, as : 'bank_holidays' },
  //     ],
  //     order : [
  //       [{ model : sequelize.models.BankHoliday, as : 'bank_holidays'}, 'date' ],
  //       [{ model : sequelize.models.LeaveType, as : 'leave_types' }, 'sort_order', 'ASC'],
  //       [{ model : sequelize.models.LeaveType, as : 'leave_types' }, 'name']
  //     ]
  //   });
  // }
  this.get_company_with_all_leave_types = function(args) {
    var companyID = args || this.companyId;
    return sequelize.models.Company.findOne({
      where   : {id : companyID},
      include : [{ model : sequelize.models.LeaveType, as : 'leave_types' },
             { model : sequelize.models.BankHoliday, as : 'bank_holidays' },
