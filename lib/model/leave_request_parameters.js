...
LeaveRequest.prototype.validate_min_days_prior = function(leave_day){
    var return_val = false;
    // get min days prior associated with leaveType
    // if min_days_prior != 0
    // get diff days between date of application and from date
    // return true if more than min_days_prior
    // return false if not.
