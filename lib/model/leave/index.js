...
console.log( "reason", JSON.stringify(valide_attributes) );
      
  valide_attributes.is_adjustment = leave_type.is_adjustment;
  valide_attributes.by_user = by_user;
  ...
  return Promise
    ...
    .then(main_supervisor => {
      ...
      const new_leave_status = (employee.is_auto_approve() /*|| (by_user.global_adjuster == 1 && valide_attributes.is_adjustment > 0)*/)
      ...
      return Promise.resolve(Models.Leave.build({
        ...
        approver_comment : valide_attributes.approver_comment,
		    attachment       : valide_attributes.attachment,
