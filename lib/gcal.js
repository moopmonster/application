...
function getCalendarId(deptid){
  let gcal_id = config.get('gcalendar_id_all');
  ...
  Models.sequelize.query( sql , { 
    ...
    if(res.comp_gcal != null && res.comp_gcal != '')
      gcal_id = res.comp_gcal;
    else if (res.dept_gcal != null && res.dept_gcal != '')
      gcal_id = res.dept_gcal;
